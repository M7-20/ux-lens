  ...
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden" aria-hidden>
      ...
      >
        ...
        <g stroke="currentColor" fill="none" strokeWidth="1.2" className="text-muted-foreground">
        ...
        <rect width="1200" height="900" fill="url(#dots)" className="text-muted-foreground" opacity="0.35" />
      </svg>

      {/* corner accents */}
      <svg className="absolute top-0 right-0 h-full w-1/2 opacity-[0.05]" viewBox="0 0 100 100" preserveAspectRatio="none">
        <path d="M100,0 Q75,50 100,100 L100,100 Z" fill="var(--muted-foreground)" />
      </svg>
